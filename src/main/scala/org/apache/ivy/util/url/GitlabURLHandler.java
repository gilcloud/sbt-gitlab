...
public class GitlabURLHandler extends AbstractURLHandler {
    private final Seq<GitlabCredentials> gitlabCredentials;

    public GitlabURLHandler(Seq<GitlabCredentials> gitlabCredentials) {
